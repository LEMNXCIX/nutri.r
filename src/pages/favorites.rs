                ...
                <div class="max-w-5xl mx-auto relative z-10">
                    <div class="space-y-6">
                         <div class="space-y-2">
                            ...
                            <h2 class="text-5xl md:text-6xl font-black text-black dark:text-white tracking-tighter leading-none">
                                "MIS FAVORITOS"
                            </h2>
            ...
            <div class="max-w-5xl mx-auto px-4">
                <Suspense fallback=move || view! {
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div class="h-64 bg-white dark:bg-neutral-900 rounded-[2.5rem] animate-pulse"></div>
                        <div class="h-64 bg-white dark:bg-neutral-900 rounded-[2.5rem] animate-pulse"></div>
                        <div class="h-64 bg-white dark:bg-neutral-900 rounded-[2.5rem] animate-pulse"></div>
                    </div>
                }>
                    {move || {
                        let content: AnyView = match plans_resource.get() {
                            Some(Ok(plans)) => {
                                if plans.is_empty() {
                                    view! {
                                        <div class="text-center py-32 px-8 bg-white dark:bg-neutral-900 rounded-[3rem] border border-gray-100 dark:border-neutral-800 shadow-xl shadow-black/5 max-w-2xl mx-auto">
                                            <div class="w-24 h-24 bg-gray-50 dark:bg-neutral-800 rounded-full flex items-center justify-center mx-auto mb-8 text-gray-300 dark:text-gray-600">
                                                <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                                </svg>
                                            </div>
                                            <h3 class="text-2xl font-black text-black dark:text-white tracking-tighter mb-4">"TU GALERÍA ESTÁ VACÍA"</h3>
                                            ...
                                            <A href="/" attr:class="inline-block bg-black dark:bg-white hover:bg-[#D4AF37] dark:hover:bg-[#D4AF37] text-white dark:text-black px-10 py-5 rounded-[1.5rem] font-black text-[11px] tracking-[0.2em] uppercase shadow-2xl shadow-black/20 transition-all">
                                                "EXPLORAR PLANES"
                                            </A>
                                        </div>
                                    }.into_any()
                            ...
                            Some(Err(e)) => {
                                view! {
                                    <div class="p-8 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/30 rounded-[2rem] text-red-600 dark:text-red-400 text-sm font-bold flex items-center gap-4">
