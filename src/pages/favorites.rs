        ...
        <div class="p-4 md:p-6 max-w-5xl mx-auto animate-in fade-in duration-500">
            <header class="mb-8">
                <div class="flex items-center gap-3 mb-2">
                    <svg class="w-8 h-8 text-black fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
                    </svg>
                    <h2 class="text-3xl font-black text-gray-900 tracking-tight">"Mis Planes Favoritos"</h2>
                </div>
                <p class="text-gray-500 font-medium">"Aquí encontrarás los planes que más te han gustado."</p>
            </header>
                            ...
                            if plans.is_empty() {
                                view! {
                                    <div class="text-center p-16 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
                                        ...
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">"Aún no tienes favoritos"</h3>
                                        <p class="text-gray-500 max-w-xs mx-auto text-sm">"Marca planes con el corazón en el detalle del plan para verlos aquí."</p>
                                    </div>
                                }.into_any()
                            } else {
                                view! {
