use crate::components::ui::{Button, Card, Loading, StarRating, TagBadge, TagSelector};
...
pub fn PlanDetail() -> impl IntoView {
    ...
    view! {
        <div class="bg-white min-h-screen font-sans text-gray-900 border-none outline-none">
