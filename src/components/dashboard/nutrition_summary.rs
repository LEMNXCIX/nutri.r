...
pub fn NutritionSummary(
    ...
    view! {
        <div class="bg-white p-6 brutalist-border flex flex-col justify-center relative overflow-hidden group">
            <div class="flex flex-col xl:flex-row items-center gap-8 relative z-10">
                ...
                <div class="relative w-32 h-32 shrink-0 flex items-center justify-center">
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
                        <span class="text-3xl font-black text-neutral-950 tracking-tighter leading-none">{calories_current}</span>
                        <div class="hairline-divider w-8 my-1"></div>
                        <span class="text-[8px] text-neutral-400 font-bold uppercase tracking-[0.2em]">{calories_target}</span>
                    </div>
                </div>

                // Macros - High Contrast High Tracked
                <div class="flex-1 w-full space-y-4">
                    <h4 class="text-[9px] font-black text-neutral-400 uppercase tracking-[0.4em]">"Nutrition Analysis"</h4>
    ...
    view! {
        <div class="space-y-1.5">
            <div class="flex items-center justify-between">
                <span class="text-[8px] font-bold text-neutral-500 uppercase tracking-[0.2em]">{label}</span>
                <span class="text-[9px] font-black text-neutral-950 tabular-nums">{percentage} "%"</span>
            </div>
            <div class="h-[1px] w-full bg-neutral-100 relative">
                <div
