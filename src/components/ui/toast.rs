    ...
    view! {
        <Portal>
            <div class="fixed bottom-32 left-6 right-6 z-[1000] md:bottom-32 md:right-8 md:left-auto md:w-96 pointer-events-none">
                <div class="pointer-events-auto brutalist-border dark:border-neutral-700 bg-white dark:bg-neutral-900 p-4 shadow-brutalist animate-in slide-in-from-bottom-4 flex items-center gap-4">
                    ...
                    <button
                        ...
                        class="p-2 hover:bg-neutral-50 dark:hover:bg-neutral-800 text-neutral-300 dark:text-neutral-600 hover:text-neutral-950 dark:hover:text-white transition-colors"
                    >
